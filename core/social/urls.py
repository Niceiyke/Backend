...
urlpatterns = [
    ...
    path('post/<str:pk>/like', AddLike.as_view(), name='like'),
    path('post/<str:pk>/dislike', AddDislike.as_view(), name='dislike'),
    path('post/<str:pk>/share', SharedPostView.as_view(), name='share-post'),
    ...
    path('notification/<str:notification_pk>/profile/<int:profile_pk>', FollowNotification.as_view(), name='follow-notification'),
    path('notification/<str:notification_pk>/thread/<int:object_pk>', ThreadNotification.as_view(), name='thread-notification'),
